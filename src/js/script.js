$(document).ready(function(){
    ...
    let autocompleteCommandsMinecraft = [
        "achievement give *",
    ...
    //   source: autocompleteCommandsMinecraft,
  ...
  function logMsg(msg, sep, cls){
    ...
    $("#groupConsole")
      .append("<li class=\"list-group-item list-group-item-" + cls + "\"><span class=\"badge text-bg-" + cls + "\">" + datetime + "</span><strong> " + sep + "</strong> " + msg + "<div class=\"clearfix\"></div></li>");
