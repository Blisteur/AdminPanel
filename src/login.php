...
<html lang="fr">
    ...
    <body>
      ...
      <div class="modal fade" tabindex="-1" id="auth">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <p class="text-danger text-center" style="display: <?php echo $connect == true ? 'all' : 'none' ?>;">Username or password is incorrect</p>
              <button type="submit" class="btn btn-primary float-end" value="Login">Submit</button>
              </form>
            </div>
          </div>
        </div>
